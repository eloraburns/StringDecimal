...
var operator_tests = [
	...
	["add", "0", "1", "1", "0 + 1 = 1"],
	["add", "1", "1", "2", "1 + 1 = 2"],
	["add", "1.0", "1", "2.0", "1.0 + 1 = 2.0"],
	["add", "1", "1.0", "2.0", "1 + 1.0 = 2.0"],
	["add", "1.0", "1.0", "2.0", "1.0 + 1.0 = 2.0"],
	["add", "1.00", "1.0", "2.00", "1.00 + 1.0 = 2.00"]
];
	...
	test("operator_tests case "+i, 1, (
		function(testcase) {
			return function() {
				...
				same(actual, testcase[3], testcase[4])
			}
		}
	)(operator_tests[i]));
}
